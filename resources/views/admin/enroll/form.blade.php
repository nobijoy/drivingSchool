<div class="row">
    ...
    <div class="form-group col-md-6 ">
        ...
        <input type="text" id="title" class="form-control" placeholder="Ex: Driving Basics" name="title"
               @if($url == 'enroll.edit') value="{{$data->title}}" @else value="{{old('title')}}" @endif required>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <input type="text" id="duration" class="form-control phone" placeholder="Ex: 30" name="duration"
               @if($url == 'enroll.edit') value="{{$data->duration}}" @else value="{{old('duration')}}" @endif required>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <input type="number" id="fee" class="form-control phone" placeholder="Ex: 100" name="fee"
               @if($url == 'enroll.edit') value="{{$data->fee}}" @else value="{{old('fee')}}" @endif required>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <input type="number" id="min_deposit" class="form-control phone" placeholder="Ex: 100" name="min_deposit"
               @if($url == 'enroll.edit') value="{{$data->min_deposit}}" @else value="{{old('min_deposit')}}" @endif required>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <select name="transmission_type" id="transmission_type" class="form-control select2" required>
            <option value="auto" @if(($url == 'enroll.edit') && $data->transmission_type == 'auto') selected @endif>Auto</option>
            <option value="manual" @if(($url == 'enroll.edit') && $data->transmission_type == 'manual') selected @endif>Manual</option>
        </select>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <select name="is_featured" id="is_featured" class="form-control select2" required>
            <option value="0" @if(($url == 'enroll.edit') && $data->is_featured == '0') selected @endif>No</option>
            <option value="1" @if(($url == 'enroll.edit') && $data->is_featured == '1') selected @endif>Yes</option>
        </select>
    </div>
    ...
    <div class="form-group col-md-6 ">
        ...
        <input type="text" id="video" class="form-control" placeholder="Video link Url" name="video"
               @if($url == 'enroll.edit') value="{{$data->video}}" @else value="{{old('video')}}" @endif>
    </div>
