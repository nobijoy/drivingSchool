...
{{--    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/uploads/image/' . $gsetting->favicon)}}">--}}
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset ('/backend/vendors/css/forms/selects/select2.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('/backend/vendors/css/weather-icons/climacons.min.css')}}">
    <link rel="stylesheet" type="text/css"
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{asset('/backend/css/core/menu/menu-types/vertical-menu.css')}}">
                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <div class="p-1">
{{--                                            <img src="{{asset ('/uploads/image/'. $gsetting->logo)}}"--}}
{{--                                                alt="branding logo">--}}
                                        </div>
                                    </div>
